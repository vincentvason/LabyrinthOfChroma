...
namespace Unity.Splines.Examples
{
    ...
    public class EnemySplineOutliner : MonoBehaviour
    {
        [SerializeField]
        ...
        EnemySplineWidth m_WidthData;
        
        EnemySplineWidth widthData
        {
            get
            {
                if(m_WidthData == null)
                    m_WidthData = GetComponent<EnemySplineWidth>();
                if(m_WidthData == null)
                    m_WidthData = gameObject.AddComponent<EnemySplineWidth>();
